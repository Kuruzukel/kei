...
<body>
    ...
    <main>
        ...
        <div class="line"></div>
            <a href="addash.php?page=dashboard" class="tab" id="dashboard-tab"><i class="fas fa-users"></i> Accounts</a>
            <a href="addash.php?page=grades" class="tab" id="grades-tab"><i class="fas fa-upload"></i> Grades Upload</a>
            <a href="addash.php?page=password" class="tab" id="password-tab"><i class="fas fa-user-lock"></i> Student password</a>
        </div>
